...
4. **Document**: When behavior, exported commands, checks, settings, permissions, or reporting semantics change, update the required docs in the same branch: `CHANGELOG.md`, `CLAUDE.md`, `AGENTS.md`, and `README.md` when user-facing behavior changes.
