@{
    ...
    #
    # This is a bundled copy of source/Settings/permissions.psd1, shipped
    # inside EntraZTAssess.Provisioning so New-ZTAssessAppRegistration can
    # grant the same read-only scope set from a PSGallery install (no
    # sibling `source/` folder exists there). Keep both files identical;
    # tests/Unit/Provisioning/New-ZTAssessAppRegistration.tests.ps1 asserts
    # this via a content diff.
    # ==========================================================================
